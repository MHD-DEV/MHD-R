...
!	ALLOCATE (COVER(NU+1,12),SCMAX(NU+1)) !
	...
	ALLOCATE (QR(NOBS,NT),QOBS(NOBS,NT/8)) !VAZ�O CALCULADA E OBSERVADA NOS EXUTORIOS DAS BACIAS
...
!	DEALLOCATE (ECB,ETPB,ETTB,SSSUB,PREB,SSUBB,ASATB,SRADB)!MEDIAS BACIA
	...
	DEALLOCATE (QR,QOBS) !VAZ�O CALCULADA E OBSERVADA NOS EXUTORIOS DAS BACIAS
