...
!	ALLOCATE (COVER(NU+1,12),SCMAX(NU+1)) !
	...
	ALLOCATE (QBSUB(NT),QBSSU(NT),QBSUP(NT))!VAZÃO DE ACORDO COM ORIGEM
	...
	ALLOCATE (QR(NOBS,NT)) !VAZÃO CALCULADA E OBSERVADA NOS EXUTORIOS DAS BACIAS
...
!	DEALLOCATE (ECB,ETPB,ETTB,SSSUB,PREB,SSUBB,ASATB,SRADB)!MEDIAS BACIA
	...
	DEALLOCATE (QR) !VAZÃO CALCULADA E OBSERVADA NOS EXUTORIOS DAS BACIAS
