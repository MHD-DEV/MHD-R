...
READ(FILFIX,75) TITULO 
WRITE(*,72) TITULO
!READ(FILFIX,71)NC,NU,NB	         		!L� NUMERO DE C�LULAS, USOS, BACIAS  
READ(FILFIX,'(I10,10X,I10)')NC,NB	         		!L� NUMERO DE C�LULAS, USOS, BACIAS  
!WRITE(*,71)NC,NU,NB			           	!L� NUMERO DE C�LULAS, USOS, BACIAS  
...
IF(ICALIB == 2) THEN ! FAZ PREVISAO
	...
	READ(FILFIX,75) TITULO
    WRITE(*,72) TITULO
    READ(FILFIX,71)IDIAPRE,IMESPRE,IANOPRE,IHORAPRE !L� DATA E HORA DO FIM DA PREVISAO
...
!READ(FILFIX,75)TITULO					!LE TEXTO
!WRITE(*,72)TITULO
!READ(FILFIX,*)NHIDG					!L� em quantos pontos se deseja gravar o hidrograma
!WRITE(*,*)NHIDG
